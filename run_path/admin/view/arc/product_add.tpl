	...
	<div class="tab-content">
		<div id="basic" class="tab-pane fade in active">
			<div class="form-group">
				...
				<div class="col-sm-5">
					<select class="form-control" id="navid" name="navid">
                        ...
                        <option value="{$nav.id}" {if condition="$nav['cid'] NEQ $cid"}disabled{/if}>
			...
			<div class="form-group">
				...
				<div class="col-sm-5">
					<input type="text" name="stitle" class="col-xs-12 col-sm-12" />
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-11">
					<input type="text" name="keywords" class="col-xs-12 col-sm-12" />
				</div>
			...
			<div class="form-group">
                ...
                <div class="col-sm-11">
                    <input type="text" name="litpic" class="col-xs-11 col-sm-11" />
			...
			<div class="form-group">
				...
				<div class="col-sm-11">
					<textarea name="body" id="body" class="col-xs-12 col-sm-12" style="margin-left:-12px"></textarea>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input type="text" name="source" class="col-xs-12 col-sm-12" />
                </div>
                <label class="col-sm-1 control-label no-padding-right"> 内容作者 </label>
                <div class="col-sm-4">
                    <input type="text" name="writer" class="col-xs-12 col-sm-12" />
                </div>
            </div>
            <div class="form-group">
