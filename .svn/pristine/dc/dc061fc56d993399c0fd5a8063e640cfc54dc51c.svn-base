{include file="public/head"/}
    ...
    <div class="main-content">
        <div class="main-content-inner">
            ...
            <div class="tabbable">
<form class="form-horizontal" method="post" id="form" action="{:url('nav/addHandle')}">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-4">
            <select class="form-control" id="pid" name="pid">
                ...
                <option value="{$nav.id}" {if condition="$nav['id'] EQ $arc['id']"}selected{/if}>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-4">
            <input type="text" name="navname" id="navname" class="col-xs-12 col-sm-12" placeholder="栏目标题必填" />
        </div>
        <label class="col-sm-1 control-label no-padding-right"> 英文标题 </label>
        <div class="col-sm-4">
            <input type="text" name="ename" class="col-xs-12 col-sm-12" placeholder="可为空" />
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-4">
            <input type="text" name="litpic" id="litpic" class="col-xs-10 col-sm-10"/>
            <a class="upbutton btn btn-primary" id="litpic_btn">选择</a>
        </div>
        
        <label class="col-sm-1 control-label no-padding-right"> 跳转地址 </label>
        <div class="col-sm-4">
            <input type="text" name="jump" class="col-xs-12 col-sm-12"/>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-11">
            <input type="text" name="seotitle" class="col-xs-12 col-sm-12" placeholder="不填写将显示：栏目标题_网站标题" />
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-11">
            <input type="text" name="keywords" class="col-xs-12 col-sm-12" placeholder="多个关键字以英文逗号分割" />
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-11">
            <textarea name="description" rows="3" class="col-xs-12 col-sm-12" placeholder="本栏目的描述信息,控制在150字以内" style="padding:5px"></textarea>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-11">
        <textarea name="content" id="content" class="col-xs-12 col-sm-12" style="margin-left:-12px" placeholder=""></textarea>
        ...
        <div class="col-sm-4">
            <div class="checkbox">
                <label style="padding:0 10px">
                    <input name="target" type="radio" class="ace" value="1">
                    <span class="lbl"> 是 </span>
                </label>
                <label style="padding:0 10px">
                    <input name="target" type="radio" class="ace" value="0" checked>
