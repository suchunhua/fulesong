...
<div class="page-content">
    <form method="post" action="{:url('addHandle')}" id="form">
        ...
        <input type="hidden" name="ctrltype" value="edit">
        <table class="table  table-bordered table-hover">
            <tbody>
                <tr>
                    <th class="cfgtable bdlno bg_f4f8fd" style="width: 150px;">收货人姓名:　</th>
                    <td ><input type="text" name="getname" id="getname" class="col-md-12" value="{$arc.getname}"></td>
                </tr>
                <tr>
                    <th class="cfgtable bdlno bg_f4f8fd" style="width: 150px;">收货人手机:　</th>
                    <td ><input type="text" name="getphone" id="getphone" class="col-md-12" value="{$arc.getphone}"></td>
                </tr>
                <tr>
                    <th class="cfgtable bdlno bg_f4f8fd" style="width: 150px;">收货人固话:　</th>
                    <td ><input type="text" name="gettel" id="gettel" class="col-md-12" value="{$arc.gettel}"></td>
                </tr>
                <tr>
                    <th class="cfgtable bdlno bg_f4f8fd" style="width: 150px;">收货人地址:　</th>
                    <td ><input type="text" name="getaddress" id="getaddress" class="col-md-12" value="{$arc.getaddress}"></td>
                </tr>
