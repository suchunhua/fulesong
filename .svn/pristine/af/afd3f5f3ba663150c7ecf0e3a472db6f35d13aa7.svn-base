...
<div class="page-content">
    <form method="post" action="{:url('addHandle')}" id="form">
        ...
        <table id="simple-table" class="table  table-bordered table-hover">
            <tbody>
                <tr>
                    <td class="cfgtable w100">字段标题:　</td>
                    <td ><input type="text" name="comment" id="comment" class="col-md-12"></td>
                    <td class="cfgtable hidden-xs">用于表单显示</td>
                </tr>
                <tr>
                    <td  class="cfgtable w100">字 &nbsp;段 &nbsp;名:　</td>
                    <td><input type="text" name="name" id="name" class="col-md-12"></td>
                    <td class="cfgtable hidden-xs">字段名 英文字母开头，长度不超过30</td>
                </tr>
