...
<div class="container ">
    <div class="yd-header">
        <p class="yd-title">感官智力运动检测综合结果</p>
        <p class="yd-word">我们一共为您检查了4500项，您有18项需要关注的风险</p>
    </div>
    <div class="list">
        <ul>
           {list row="60"}
            <li class="list-li">
                ...
                <div class="list-li-content">
                    <span class="list-li-q">{$arc.title}</span>
                    <p class="list-li-w {if condition='in_array($arc["stitle"],["相对偏高","相对偏低"])'}w-red{/if}" >{$arc.stitle}<img src="{$style}/images/more-2.png"></p>
                </div>
                    </a>
            </li>
            {/list}
